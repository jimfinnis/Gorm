...
public class Furniture {
	public static void cornerShelves(Extent e, MaterialManager mgr, int carpet){
		...
		Extent cookieCutter = new Extent(corner1.maxx,corner1.miny,corner1.minz);
		...
		GormPlugin.log("Shelves at " + corner1.maxx + " " + corner1.maxy + " " + corner1.maxz);
		Extent corner2 = new Extent(e.maxx - 1,e.miny,e.minz);
		corner2.maxx = e.maxx;
		corner2.maxy = e.maxy;
		corner2.maxz ++;
		c.fill(corner2,Material.BOOKSHELF,0);
		Extent cookieCutter2 = new Extent(corner2.minx,corner2.miny,corner2.maxz);
		...
		GormPlugin.log("Shelves at " + corner2.maxx + " " + corner2.maxy + " " + corner2.maxz);
	}
